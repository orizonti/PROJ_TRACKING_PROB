...
public:
	...
	{
		qDebug() << "[MESSAGE ITEATOR CREATE  (FIXED CHUNKED TYPE) ]";
	};
...
public:
	...
	MessageIteratorGenericBase<H>(STORAGE, ChunkSize, NumberChunks)
	{
		qDebug() << "[MESSAGE ITEATOR CREATE  (CHUNKED TYPE) ]";
	};
...
public:
	...
	MessageIteratorGenericBase<H>(STORAGE, ChunkSize, NumberChunks)
	{
		qDebug() << "[MESSAGE ITEATOR CREATE  (CHUNKED CONTINOUS TYPE) ]";
	};
...
public:
	...
	MessageIteratorGenericBase<H>(STORAGE, ChunkSize, NumberChunks)
	{
		qDebug() << "[MESSAGE ITEATOR CREATE (CONTINOUS TYPE) ]";
	};
