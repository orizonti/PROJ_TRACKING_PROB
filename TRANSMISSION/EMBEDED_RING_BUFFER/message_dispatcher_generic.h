...
void MessageDispatcherGenericClass<MessagesListScanatorFull>::DispatchNextMessage(RingBufferType& RingBuffer)
{
    ...
    //else qDebug() << "[ MESSAGE DISPATCHER ] BUFFER AT enD"; 
}
