...
DeviceRotary->setNull(QPair<float,float>(42.00,-5.3));
}
#endif
...
void ProcessControllerClass::slotStartProcessRTSP (bool OnOff) { ModuleVideoOutput->linkToSource(DeviceCamera.get()); }
